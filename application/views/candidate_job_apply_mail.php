                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0" style="
                                            ...
                                            <tbody><tr>
                                                    <td colspan="2" style="padding: 5px 20px;text-align:center;font-weight:700;/* margin-left: 16px; */">
                                                        <p style="text-transform: uppercase">Candidate Applied For Job</p>
                                            ...
                                            <tbody><tr>
                                                    ...
                                                    if (isset($candidate) && is_array($candidate) && count($candidate) > 0) {
                                                        ...
                                                        <td colspan="2" style="line-height: 24px;padding:0 20px 10px;text-align:left;/* margin-left: 16px; */">
                                                            <p style="margin-top:15px;"><a href="<?php echo site_url('candidate/candidate_admin/view/'.$candidate['id']);?>"><strong><?php echo isset($candidate['name']) ? $candidate['name'] : ''; ?></strong> </a> Apply for <a href="<?php echo site_url('jobs/jobs_admin/view/'.$job['id']);?>"><strong><?php echo isset($job['title']) ? $job['title'] : ''; ?></strong> Job
                                                           <?php
                                                        }
                                                        ?>
