                                        ...
                                        <tbody>
                                            <tr>
                                                <td colspan="2" style="padding: 5px 20px;text-align:center;font-weight:700;/* margin-left: 16px; */">
                                                    <p style="text-transform: uppercase">Candidate Purchase Package</p>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    ...
                                                    <p><?php echo $candidate['name']; ?> (<?php echo $candidate['email_id']; ?>) Purchases following package: <?php echo $packages['package_name']; ?></p>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td colspan="2" style="padding:0 20px;text-align:left;padding: 0 0 0 20px;text-align: left;">
                                                    ...
                                                    <p style="height:20px;"></p>
                                                    <p style="font-style:italic;font-weight:700;color: #1a51a4;">Falcon Multi Services LTD</p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <tr>
                                <td colspan="2" style="padding: 0px;background: #0e9046;">
                                    <table width="100%" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            <tr>
                                                <td colspan="2" style="background-color: #1a51a4;padding: 15px 0;text-align: center;color: #fff;">
